    ...
    <Dialog.Root open onOpenChange={(open) => !open && onClose()}>
      ...
      <Dialog.Content className="dialog-content">
        <div className="dialog-box">
          <Dialog.Title className="dialog-title">{buildingDetails.building_name}</Dialog.Title>
          <img
            src={buildingDetails.building_image || '/assets/dummy/image-placeholder.png'}
            alt={buildingDetails.building_name}
            className="dialog-image"
          />
          <p className="dialog-details">Rooms: {buildingDetails.num_of_rooms}</p>
          <p className="dialog-details">Floors: {buildingDetails.num_of_floors}</p>

          <div className="button-group">
            <Button onClick={onEdit} className="dialog-button dialog-edit-button">
              Edit Details
            </Button>
            <Button onClick={onClose} className="dialog-button dialog-close-button">
              Close
            </Button>
          </div>
        </div>
