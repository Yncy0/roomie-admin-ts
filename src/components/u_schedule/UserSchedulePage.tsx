...
const UserSchedulePage: React.FC = () => {
  ...
  const openModal = useCallback(
    (type: "booking" | "schedule", event?: BookingData | ScheduleData) => {
      setModalType(type);
    ...
    try {
      ...
      if (modalType === "schedule") {
        ...
        if (subjectError || !subjectData) {
          alert(
            "Error fetching subject_id: No subject found for the given subject_code."
          );
          return;
        }
    ...
    <Box sx={{ position: "relative" }}>
      <Box sx={{ padding: 3, color: "black", display: "flex" }}>
        ...
        <Box sx={{ flexGrow: 1, padding: "20px" }}>
          {isLoading ? (
                    ...
                    <Table>
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            {userInfo?.mobile_number || "Unknown"}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>Department:</TableCell>
                          <TableCell>
                            {userInfo?.user_department || "Unknown"}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>User Role:</TableCell>
                          <TableCell>
                            {userInfo?.user_role || "Unknown"}
                          </TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
            ...
            <Typography>
              Please select a user to view their schedule.
            </Typography>
          )}
        </Box>
      </Box>
      ...
      <PrintablePage
        ...
        bookingData={bookingData.filter(
          (event) => event.user_name === selectedUser
        )}
